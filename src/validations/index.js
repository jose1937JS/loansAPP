...
const validationSchema = object({
  ...
  amount: number().required('Este campo es requerido'),
  description: string().trim().nullable(),
  estimated_refund_date: date().required('Este campo es requerido'),
  ...
  rate_type: string().oneOf(['bvc', 'enparalelovzla']).required('Este campo es requerido'),
})
